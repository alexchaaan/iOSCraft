...
class CListViewRenderer{        
    public:
        typedef enum{
            ...
            lvoDownArrow = -2,
            lvoNone = -3
        } EListViewObject, *EListViewObjectRef;
    ...
    public:
        ...
        void DrawListView(GdkDrawable *drawable, int selectedindex, int offsetindex, std::vector< std::string > &items);
};
